...
ENV APACHE_DOCUMENT_ROOT /usr/share/abraflexi-webhook-acceptor/
...
RUN aptitude -y install abraflexi-webhook-acceptor-sqlite abraflexi-matcher abraflexi-reminder abraflexi-contract-invoices abraflexi-digest

RUN phinx seed:run -c /usr/lib/abraflexi-webhook-acceptor/phinx-adapter.php
RUN a2ensite abraflexi-webhook-acceptor
